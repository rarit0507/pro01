		...
		<div style="width:1400px;margin:15px auto">
			<nav aria-label="breadcrumb" style="text-align:right">
			  <ol class="breadcrumb">
			    ...
			    <li class="breadcrumb-item active" aria-current="page">문화시설 안내</li>
			  </ol>
			</nav>
			<hr>
			<div id="tab1">
			<ul class="nav nav-tabs">
			  ...
			  <li class="nav-item">
			    <a class="nav-link" href="${path0 }/district/districtList.jsp">지역시설 안내</a>
			  </li>
			  <li class="nav-item">
			    <a class="nav-link active" href="${path0 }/cultural/culturalList.jsp">문화시설 안내</a>
			  </li>
			  <li class="nav-item">
