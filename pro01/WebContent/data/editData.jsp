...
<div id="contents">
	<section class="page" id="page1">
		<div style="width:1400px; margin:0 auto;">
			<h3 class="page_title">자료실 글 수정</h3>
			<form action="${path0 }/EditProData.do" method="post">
				<table class="table">
					<tbody>
						...
						<tr>
							<th><label for="content">자료</label></th>
							<td>
								<textarea name="content" id="content" rows="8" cols="80" class="form-control">${data.datafile }</textarea>
							</td>
						</tr>
						<tr>
				...
				<hr>
				<div class="btn-group">
				  <button type="submit" class="btn btn-secondary">자료실 글 수정</button>
				  <a href="${path0 }/DataList.do" class="btn btn-secondary">자료실 목록</a>
				  <a href="${path0 }/GetData.do?no=${data.no} " class="btn btn-secondary">자료실 글 상세보기</a>
				</div>
			</form>
		</div>
	</section>	
