	...
	<section class="page" id="page1">
		<div style="width:1400px; margin:0 auto;">
			...
			<div>
					...
					<tbody>
						<c:if test="${not empty dataList }">
							...
							<tr>
								...
								<td>${dto.resdate }</td><td>${dto.visited }</td><td>${dto.content }</td>
							</tr>
							</c:forEach>
						</c:if>
						<c:if test="${empty dataList }">
							<tr>
								<td colspan="5"><strong>자료가 존재하지 않습니다.</strong></td>
							</tr>
						</c:if>
					</tbody>
				</table>
				...
				<div class="btn-group">
				  <a href="${path0 }/data/data_ins.jsp" class="btn btn-secondary">자료실 글 등록</a>
				</div>
				</c:if>
			</div>
		</div>
